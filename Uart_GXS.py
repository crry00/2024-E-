...
class Uart:
    ...
    #param11, param22,param33, param44,param55, param66=0,0,0,0,0,0
    ...
    def uart_send_angle(self,  param1 , param2, fn=1):
        print(f"@!{param1}|{param2}|{fn}")
        myinput=bytes([0xee,param1,param2,fn])
        self.uart.write(myinput)
        #time.sleep(0.2)  # 避免单片机清零不及时
        # if wait is True:
        #     task, color=self.wait_for_32_ack(timeout)
